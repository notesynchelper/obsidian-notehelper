...
// src/build-config.ts
var isLocalTest = process.env.LOCAL_TEST === "true" || true;
var BUILD_CONFIG = {
...
var LOCAL_TEST_CONFIG = {
  LOCAL_API_BASE_URL: "http://localhost:3001",
  LOCAL_GRAPHQL_ENDPOINT: "http://localhost:3001/api/graphql",
  LOCAL_CONTENT_ENDPOINT: "http://localhost:3001/api/content",
...
var DEFAULT_SETTINGS = {
  ...
  endpoint: getEndpointUrl("https://api-prod.omnivore.app/api/graphql"),
  filename: "{{{title}}}",
