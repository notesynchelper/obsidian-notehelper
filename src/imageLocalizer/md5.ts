/**
 * MD5 hash for ArrayBuffer/Uint8Array input.
 *
 * Self-contained, dependency-free. Adapted from Joseph Myers' public-domain
 * implementation (https://www.myersdaily.org/joseph/javascript/md5-text.html).
 * Used solely for local image-cache filename derivation; not for any
...
function md51(bytes: Uint8Array): number[] {
  ...
  // Higher 32 bits — assume payload < 2^32 bits which holds for our use
  md5cycle(state, md5blk(tail))
  return state
}
